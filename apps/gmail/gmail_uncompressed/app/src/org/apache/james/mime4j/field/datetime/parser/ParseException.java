...
public class ParseException extends Exception
{
    ...
    public ParseException(final g currentToken, final int[][] expectedTokenSequences, final String[] tokenImage) {
        super("");
        this.eol = System.getProperty("line.separator", "\n");
    ...
    public String getMessage() {
        ...
        final String string2 = s + "\" at line " + this.currentToken.cGu.cFW + ", column " + this.currentToken.cGu.cFX + "." + this.eol;
        String s2;
