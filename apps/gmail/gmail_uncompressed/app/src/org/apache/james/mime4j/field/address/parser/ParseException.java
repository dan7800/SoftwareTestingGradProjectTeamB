...
public class ParseException extends Exception
{
    ...
    public ParseException(final u currentToken, final int[][] expectedTokenSequences, final String[] tokenImage) {
        super("");
        this.eol = System.getProperty("line.separator", "\n");
    ...
    public String getMessage() {
        ...
        final String string2 = s + "\" at line " + this.currentToken.cGb.cFW + ", column " + this.currentToken.cGb.cFX + "." + this.eol;
        String s2;
