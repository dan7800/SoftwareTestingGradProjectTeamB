...
class Lists$TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable
{
    ...
    Lists$TransformingSequentialList(final List<F> list, final b<? super F, ? extends T> b) {
    ...
    @Override
    public ListIterator<T> listIterator(final int p0) {
        // 
        ...
        //     4: aload_0        
        //     5: aload_0        
        //     6: getfield        com/google/common/collect/Lists$TransformingSequentialList.fromList:Ljava/util/List;
        //     9: iload_1        
        //    10: invokeinterface java/util/List.listIterator:(I)Ljava/util/ListIterator;
