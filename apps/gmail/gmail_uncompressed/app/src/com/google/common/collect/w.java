...
final class W<K, V> extends AbstractQueue<af<K, V>>
{
    final af<K, V> cBA;
    ...
    W() {
        ...
        // Original Bytecode:
        // 
        //     1: invokespecial   java/util/AbstractQueue.<init>:()V
        //     4: aload_0        
        //     5: new             new            !!! ERROR
        //     8: dup            
        //     9: aload_0        
        //    10: invokespecial   invokespecial  !!! ERROR
        //    13: putfield        com/google/common/collect/W.cBA:Lcom/google/common/collect/af;
        //    16: return         
        // 
    ...
    public final void clear() {
        af<K, V> zy2;
        for (af<K, V> zy = this.cBA.ZY(); zy != this.cBA; zy = zy2) {
            zy2 = zy.ZY();
            MapMakerInternalMap.e(zy);
        }
        this.cBA.h(this.cBA);
        this.cBA.i(this.cBA);
    }
    ...
    public final boolean contains(final Object o) {
        return ((af)o).ZY() != MapMakerInternalMap$NullEntry.cBO;
    }
    
    @Override
    public final boolean isEmpty() {
        return this.cBA.ZY() == this.cBA;
    }
    
    @Override
    public final Iterator<af<K, V>> iterator() {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //     4: aload_0        
        //     5: aload_0        
        //     6: invokespecial   com/google/common/collect/W.aaa:()Lcom/google/common/collect/af;
        //     9: invokespecial   invokespecial  !!! ERROR
        //    12: areturn        
        //    Signature:
        //  ()Ljava/util/Iterator<Lcom/google/common/collect/af<TK;TV;>;>;
        // 
        // The error that occurred was:
        // 
        // java.lang.IllegalArgumentException: Argument 'typeArguments' must not have any null elements.
    ...
    public final boolean remove(final Object o) {
        final af af = (af)o;
        final af<K, V> zz = af.ZZ();
        final af<K, V> zy = af.ZY();
        MapMakerInternalMap.b((af<Object, Object>)zz, (af<Object, Object>)zy);
        MapMakerInternalMap.e(af);
        return zy != MapMakerInternalMap$NullEntry.cBO;
    }
    
    @Override
    public final int size() {
        int n = 0;
        for (af<K, V> af = this.cBA.ZY(); af != this.cBA; af = af.ZY()) {
            ++n;
        }
        return n;
    }
