...
{
    private final transient ImmutableList<D> cAC;
    
    TransformedImmutableList(final ImmutableList<D> list) {
        this.cAC = i.ak(list);
    }
    ...
    @Override
    public final ImmutableList<E> al(final int p0, final int p1) {
        // 
        ...
        //     4: aload_0        
        //     5: aload_0        
        //     6: getfield        com/google/common/collect/TransformedImmutableList.cAC:Lcom/google/common/collect/ImmutableList;
        //     9: iload_1        
        //    10: iload_2        
        //    11: invokevirtual   com/google/common/collect/ImmutableList.al:(II)Lcom/google/common/collect/ImmutableList;
        //    14: invokespecial   invokespecial  !!! ERROR
        //    17: areturn        
        //    Signature:
        //  (II)Lcom/google/common/collect/ImmutableList<TE;>;
        // 
    ...
    public boolean equals(final Object o) {
        if (o != this) {
            ...
            if (this.size() != list.size() || !I.a(this.YX(), list.iterator())) {
                return false;
            }
        }
        return true;
    ...
    public final aK<E> fi(final int p0) {
        ...
        //     4: aload_0        
        //     5: aload_0        
        //     6: invokevirtual   com/google/common/collect/TransformedImmutableList.size:()I
        //     9: iload_1        
