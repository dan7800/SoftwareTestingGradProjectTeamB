...
# static fields
.field private static final cyE:Ljava/util/Map;
...
.field private static final cyF:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
# instance fields
.field private final cyG:Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/Class",
            "<*>;"
...
.field private final cyI:Ljava/util/IdentityHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field final cyJ:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/api/client/util/k;->cyE:Ljava/util/Map;
    ...
    sput-object v0, Lcom/google/api/client/util/k;->cyF:Ljava/util/Map;
...
.method private constructor <init>(Ljava/lang/Class;Z)V
    ...
    iput-object v0, p0, Lcom/google/api/client/util/k;->cyI:Ljava/util/IdentityHashMap;

    .line 160
    iput-object p1, p0, Lcom/google/api/client/util/k;->cyG:Ljava/lang/Class;

    .line 161
    iput-boolean p2, p0, Lcom/google/api/client/util/k;->cyH:Z
    ...
    .line 174
    invoke-virtual {v9}, Lcom/google/api/client/util/t;->getName()Ljava/lang/String;
    ...
    .line 180
    :goto_2
    iget-object v0, p0, Lcom/google/api/client/util/k;->cyI:Ljava/util/IdentityHashMap;
    ...
    invoke-static {v2, v10, v11}, Lcom/google/api/client/a/a/a/a/a/a;->a(ZLjava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 194
    iget-object v1, v0, Lcom/google/api/client/util/k;->cyJ:Ljava/util/List;

    invoke-virtual {v5, v1}, Ljava/util/TreeSet;->addAll(Ljava/util/Collection;)Z

    .line 195
    iget-object v0, v0, Lcom/google/api/client/util/k;->cyI:Ljava/util/IdentityHashMap;
    ...
    .line 197
    iget-object v3, p0, Lcom/google/api/client/util/k;->cyI:Ljava/util/IdentityHashMap;
    ...
    :goto_7
    iput-object v0, p0, Lcom/google/api/client/util/k;->cyJ:Ljava/util/List;
...
.method public static a(Ljava/lang/Class;Z)Lcom/google/api/client/util/k;
    ...
    sget-object v0, Lcom/google/api/client/util/k;->cyF:Ljava/util/Map;
    ...
    .line 85
    :cond_2
    sget-object v0, Lcom/google/api/client/util/k;->cyE:Ljava/util/Map;
...
.method public static h(Ljava/lang/Class;)Lcom/google/api/client/util/k;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final Yo()Z
    ...
    .prologue
    .line 112
    iget-boolean v0, p0, Lcom/google/api/client/util/k;->cyH:Z

    return v0
.end method

.method public final Yp()Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final getField(Ljava/lang/String;)Ljava/lang/reflect/Field;
    .locals 1

    .prologue
    .line 138
    invoke-virtual {p0, p1}, Lcom/google/api/client/util/k;->hw(Ljava/lang/String;)Lcom/google/api/client/util/t;
...
.method public final hw(Ljava/lang/String;)Lcom/google/api/client/util/t;
    .locals 1
...
.method public final isEnum()Z
    ...
    .prologue
    .line 148
    iget-object v0, p0, Lcom/google/api/client/util/k;->cyG:Ljava/lang/Class;
