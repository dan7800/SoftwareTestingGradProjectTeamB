...
.field private dW:Landroid/app/Notification$Builder;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/ax;->eb:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/ax;->dW:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/ax;->cV:Landroid/os/Bundle;

    .line 103
    if-eqz p18, :cond_0

    .line 104
    iget-object v4, p0, Landroid/support/v4/app/ax;->cV:Landroid/os/Bundle;
...
.method public final a(Landroid/support/v4/app/au;)V
    ...
    .prologue
    .line 124
    iget-object v0, p0, Landroid/support/v4/app/ax;->eb:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/ax;->dW:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/aw;->b(Landroid/app/Notification$Builder;Landroid/support/v4/app/au;)Landroid/os/Bundle;
...
.method public final ah()Landroid/app/Notification$Builder;
    .locals 1

    .prologue
    .line 129
    iget-object v0, p0, Landroid/support/v4/app/ax;->dW:Landroid/app/Notification$Builder;
...
.method public final build()Landroid/app/Notification;
    ...
    .line 136
    invoke-static {v1}, Landroid/support/v4/app/aw;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/app/ax;->cV:Landroid/os/Bundle;
    ...
    invoke-static {v0}, Landroid/support/v4/app/aw;->a(Ljava/util/List;)Landroid/util/SparseArray;
