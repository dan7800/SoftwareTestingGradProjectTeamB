...
.method public final b(Landroid/support/v4/app/ab;)Landroid/app/Notification;
    ...
    .prologue
    .line 558
    iget-object v0, p1, Landroid/support/v4/app/ab;->mContext:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/ab;->dF:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/ab;->dm:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/ab;->dk:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/ab;->dn:I

    iget-object v7, p1, Landroid/support/v4/app/ab;->di:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/ab;->dj:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/ab;->dl:Landroid/graphics/Bitmap;
